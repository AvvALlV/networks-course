...
```sh
python server.py port_num [--cached] [--backlist]
```

1. Отправка get-запросов: www.google.com

![alt text](images/simple_get.png)

2. Ошибка: www.google.com/test

![alt text](images/error.png)

3. Post-запрос: httpbin.org/post
...
![alt text](images/blacklist.png)

![alt text](images/blacklist_log.png)
